	...
	<div id="background_board" >
		...
		<div class= "login-form-left-side">
			<fieldset>
				...
				<br>
				<a href="javascript:gister();" id="RegisterBtn"
	...
	<div id="layer1" class="layerPosition layerPop layerType2" style="width: 600px;">
      <form id="RegisterForm" action="" method="post">
		...
		<dl>
			...
			<dd class="content">
				<div class="btn_areaC">
					<a href="javascript:instafgister();" class="btnType blue" id="register_instaff"><span>일반회원</span></a>
					<a href="javascript:outstafgister();" class="btnType " id="register_outstaff"><span>기업회원</span></a>
					<br>
					<br>
				</div>
				<!-- s : 여기에 내용입력 -->
