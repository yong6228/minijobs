					...
					<div class="content" style="margin-bottom:20px;">
						...
						<p class="Location">
							<a href="../dashboard/dashboard.do" class="btn_set home">메인으로</a> <span
								class="btn_nav bold">정보목록 / 개발자목록</span> <a href="../enginfo/engineerMng.do"
						...
						<div class="selectProject" >
							<table width="100%" cellpadding="5" cellspacing="0" border="1"
		                        ...
		                        <tr style="border: 10px; border-color: blue">
		                           ...
		                           <a href="javascript:fListInf()" class="btnType blue" id="searchBtn" name="btn"><span>검  색</span></a></td> 
		                           <td width="20" height="25" style="font-size: 120%">&nbsp;&nbsp;</td>        
		                        </tr>
		                        <tr>
		                        	<td width="100" height="60" align="right">
		                        	<a href="javascript:fPopModal()" class="btnType blue" name="btn"><span>신규등록</span></a></td> 
		                     </table>    
						</div>
