...
(function (factory) {
  ...
  var editor = renderer.create('<div class="bts note-editor note-frame panel panel-default"/>');
  var toolbar = renderer.create('<div class="bts note-toolbar panel-heading"/>');
  var editingArea = renderer.create('<div class="bts note-editing-area"/>');
  var codable = renderer.create('<textarea class="bts note-codable"/>');
  var editable = renderer.create('<div class="bts note-editable panel-body" contentEditable="true"/>');
  var statusbar = renderer.create([
    '<div class="bts note-statusbar">',
    '  <div class="bts note-resizebar">',
    '    <div class="bts note-icon-bar"/>',
    '    <div class="bts note-icon-bar"/>',
    '    <div class="bts note-icon-bar"/>',
    '  </div>',
    '</div>'
  ...
  var airEditor = renderer.create('<div class="bts note-editor"/>');
  var airEditable = renderer.create('<div class="bts note-editable" contentEditable="true"/>');

  var buttonGroup = renderer.create('<div class="bts note-btn-group btn-group">');

  var dropdown = renderer.create('<div class="bts dropdown-menu">', function ($node, options) {
  ...
  var dropdownCheck = renderer.create('<div class="bts dropdown-menu note-check">', function ($node, options) {
    var markup = $.isArray(options.items) ? options.items.map(function (item) {
      var value = (typeof item === 'string') ? item : (item.value || '');
      var content = options.template ? options.template(item) : item;
  ...
  var palette = renderer.create('<div class="bts note-color-palette"/>', function ($node, options) {
    var contents = [];
    for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
      ...
      for (var col = 0, colSize = colors.length; col < colSize; col++) {
        ...
        buttons.push([
          '<button type="button" class="bts note-color-btn"',
      ...
      contents.push('<div class="bts note-color-row">' + buttons.join('') + '</div>');
    }
  ...
  var dialog = renderer.create('<div class="bts modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      '<div class="bts modal-dialog">',
      '  <div class="bts modal-content">',
      (options.title ?
      '    <div class="bts modal-header">' +
      '      <button type="button" class="bts close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
      '      <h4 class="bts modal-title">' + options.title + '</h4>' +
      '    </div>' : ''
      ),
      '    <div class="bts modal-body">' + options.body + '</div>',
      (options.footer ?
      '    <div class="bts modal-footer">' + options.footer + '</div>' : ''
      ),
      '  </div>',
      '</div>'
    ].join(''));
  ...
  var popover = renderer.create([
    '<div class="bts note-popover popover in">',
    '  <div class="bts arrow"/>',
    '  <div class="bts popover-content note-children-container"/>',
    '</div>'
  ...
  var checkbox = renderer.create('<div class="bts checkbox"></div>', function ($node, options) {
      $node.html([
  ...
  var icon = function (iconClassName, tagName) {
    tagName = tagName || 'i';
    return '<' + tagName + ' class="bts ' + iconClassName + '"/>';
  };
  ...
  var ui = {
    ...
    button: function ($node, options) {
      return renderer.create('<button type="button" class="bts note-btn btn btn-default btn-sm" tabindex="-1">', function ($node, options) {
  ...
  */
  ...
  var Dropzone = function (context) {
    ...
    var $dropzone = $([
      '<div class="bts note-dropzone">',
      '  <div class="bts note-dropzone-message"/>',
      '</div>'
...
/*      documentEventHandlers.onDrop = function () {
  ...
  var Handle = function (context) {
    ...
    this.initialize = function () {
      this.$handle = $([
        '<div class="bts note-handle">',
        '<div class="bts note-control-selection">',
        '<div class="bts note-control-selection-bg"></div>',
        '<div class="bts note-control-holder note-control-nw"></div>',
        '<div class="bts note-control-holder note-control-ne"></div>',
        '<div class="bts note-control-holder note-control-sw"></div>',
        '<div class="bts ',
        (options.disableResizeImage ? 'note-control-holder' : 'note-control-sizing'),
        ' note-control-se"></div>',
        (options.disableResizeImage ? '' : '<div class="bts note-control-selection-info"></div>'),
        '</div>',
        '</div>'
  ...
  var Placeholder = function (context) {
    ...
    this.initialize = function () {
      this.$placeholder = $('<div class="bts note-placeholder">');
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
        ...
        return ui.buttonGroup([
          ...
          ui.dropdown({
            ...
            template: function (item) {
              ...
              var className = item.className ? ' class="bts ' + item.className + '"' : '';
      ...
      context.memo('button.fontname', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: ui.dropdownButtonContents('<span class="bts note-current-fontname"/>', options),
      ...
      context.memo('button.fontsize', function () {
        return ui.buttonGroup([
          ui.button({
            className: 'dropdown-toggle',
            contents: ui.dropdownButtonContents('<span class="bts note-current-fontsize"/>', options),
      ...
      context.memo('button.color', function () {
        return ui.buttonGroup({
          ...
          children: [
            ...
            ui.dropdown({
              items: [
                '<div class="bts note-palette">',
                '  <div class="bts note-palette-title">' + lang.color.background + '</div>',
                '  <div>',
                '    <button type="button" class="bts note-color-reset btn btn-light" data-event="backColor" data-value="inherit">',
                lang.color.transparent,
                '    </button>',
                '  </div>',
                '  <div class="bts note-holder" data-event="backColor"/>',
                '</div>',
                '<div class="bts note-palette">',
                '  <div class="bts note-palette-title">' + lang.color.foreground + '</div>',
                '  <div>',
                '    <button type="button" class="bts note-color-reset btn btn-light" data-event="removeFormat" data-value="foreColor">',
                lang.color.resetToDefault,
                '    </button>',
                '  </div>',
                '  <div class="bts note-holder" data-event="foreColor"/>',
                '</div>'
              ].join(''),
      ...
      context.memo('button.table', function () {
        return ui.buttonGroup([
          ...
          ui.dropdown({
            ...
            items: [
              '<div class="bts note-dimension-picker">',
              '  <div class="bts note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"/>',
              '  <div class="bts note-dimension-picker-highlighted"/>',
              '  <div class="bts note-dimension-picker-unhighlighted"/>',
              '</div>',
              '<div class="bts note-dimension-display">1 x 1</div>'
            ].join('')
          })
        ], {
    ...
    this.addImagePopoverButtons = function () {
      ...
      context.memo('button.imageSize100', function () {
        return ui.button({
          contents: '<span class="bts note-fontsize-10">100%</span>',
      ...
      context.memo('button.imageSize50', function () {
        return  ui.button({
          contents: '<span class="bts note-fontsize-10">50%</span>',
      ...
      context.memo('button.imageSize25', function () {
        return ui.button({
          contents: '<span class="bts note-fontsize-10">25%</span>',
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="bts form-group note-form-group">' +
                   '<label class="bts note-form-label">' + lang.link.textToDisplay + '</label>' +
                   '<input class="bts note-link-text form-control '+
                   ' note-form-control  note-input" type="text" />' +
                 '</div>' +
                 '<div class="bts form-group note-form-group">' +
                   '<label class="bts note-form-label">' + lang.link.url + '</label>' +
                   '<input class="bts note-link-url form-control note-form-control ' +
      ...
      (!options.disableLinkTarget ?
          $('<div/>').append(ui.checkbox({ id: 'sn-checkbox-open-in-new-window', text: lang.link.openInNewWindow, checked: true }).render())
              .html()
          : '');
      var footer = '<button href="#" class="bts btn btn-primary note-btn note-btn-primary ' +
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="bts form-group note-form-group note-group-select-from-files">' +
                   '<label class="bts note-form-label">' + lang.image.selectFromFiles + '</label>' +
                   '<input class="bts note-image-input form-control note-form-control note-input" '+
                   ' type="file" name="files" accept="image/*" multiple="multiple" />' +
                   imageLimitation +
                 '</div>' + 
                 '<div class="bts form-group note-group-image-url" style="overflow:auto;">' +
                   '<label class="bts note-form-label">' + lang.image.url + '</label>' +
                   '<input class="bts note-image-url form-control note-form-control note-input ' +
                   ' col-md-12" type="text" />' +
                 '</div>';
      var footer = '<button href="#" class="bts btn btn-primary note-btn note-btn-primary ' +
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="bts form-group note-form-group row-fluid">' +
          '<label class="bts note-form-label">' + lang.video.url + ' <small class="bts text-muted">' + lang.video.providers + '</small></label>' +
          '<input class="bts note-video-url form-control  note-form-control note-input span12" ' + 
          ' type="text" />' +
          '</div>';
      var footer = '<button href="#" class="bts btn btn-primary note-btn note-btn-primary ' + 
  ...
  var HelpDialog = function (context) {
    ...
    this.createShortCutList = function () {
      ...
      return Object.keys(keyMap).map(function (key) {
        ...
        var $row = $('<div><div class="bts help-list-item"/></div>');
  ...
  var HintPopover = function (context) {
    ...
    this.createItemTemplates = function (hintIdx, items) {
      ...
      return items.map(function (item, idx) {
        var $item = $('<div class="bts note-hint-item"/>');
    ...
    this.createGroup = function (idx, keyword) {
      var $group = $('<div class="bts note-hint-group note-hint-group-' + idx + '"/>');
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      toolbar: [
        ...
        ['table', ['table']],
        //['insert', ['link', 'picture', 'video']], // 이미지 드래그 엔 드롭 기능 비활성 20171214
        ['insert', ['link', 'video']],
