...
public interface ProjectlistDao {
	...
	/* 프로젝트 조회 */
	public List<Projectlist> listProjectCod(Map<String, Object> paramMap);
	
	/* 프로젝트 목록 카운트 조회 */
	public int countListProjectCod(Map<String, Object> paramMap);
	...
	/** 프로젝트 저장 */
	public int insertProjectCod(Map<String, Object> paramMap);
	
	/** 프로젝트 수정 */
	public int updateProjectCod(Map<String, Object> paramMap);
	
	/** 프로젝트 수정 */
	public int deleteProjectCod(Map<String, Object> paramMap);
	...
	/* 프로젝트 면접형식 조회 */
	public List<ProjectInterview> listInterview(Map<String, Object> paramMap);
	
	public int insertInterviewCod(Map<String, Object> paramMap);
	
	public int updateInterviewCod(Map<String, Object> paramMap);
	
	public int deleteInterviewCod(Map<String, Object> paramMap);
