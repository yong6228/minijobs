...
public interface FreeBoardDao {
	...
	//자유게시판 전체조회
	public List<FreeBoardModel> boardList(Map<String, Object> prarmMap) throws Exception;
	// 자유게시판 총 건수 조회
	public int boardCnt(Map<String, Object> prarmMap) throws Exception;
	// 자유게시판 단건 조회
	public FreeBoardModel boradDetail(Map<String, Object> prarmMap) throws Exception;
	// 자유게시판 신규 등록
